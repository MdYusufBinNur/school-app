    ...
    swal({
        ...
        function(isConfirm){
            if (isConfirm) {
                //alert('hi')
                swal("Success", "Your imaginary file is deleted", "success");
                window.location.href = '/delete_contact_page/'+id;
            } else {
                swal("Cancelled", "Your imaginary file is safe :)", "error");
            }
        });
...
function get_address_data(id) {
    $.ajax({
        url: '/get_address_info/'+id,
        method: 'get',
        success: function (data) {
            //alert(data)
            console.log(data);
            ...
            let ad = object.address;
            //alert(ad);
            //alert(object.title_description)
            $('#address_id').val(object.id);
            $('#ein_no').val(object.ein_no);
            $('#college_code').val(object.college_code);
            $('#school_code').val(object.school_code);
            $('#phone').val(object.phone);
            $('#new_address').val(ad);
        }
    })
...
function get_message_data(id) {
    $.ajax({
        ...
        success: function (data)
        {
            ...
            $('textarea#message ').val(object.message);
...
function get_notice_data(id) {
    $.ajax({
        url: '/get_notice_info/'+id,
        method: 'get',
        success: function (data) {
            //alert(data)
            console.log(data);
            ...
            //alert(object.title_description)
            $('#notice_id').val(object.id);
            $('#notice_title').val(object.title);
    ...
    swal({
        ...
        function(isConfirm){
            if (isConfirm) {
                //alert('hi')
                swal("Success", "Your imaginary file is deleted", "success");
                window.location.href = '/delete_notice/'+id;
            } else {
                swal("Cancelled", "Your imaginary file is safe :)", "error");
            }
        });
...
function get_facility_data(id) {
    $.ajax({
        url: '/get_facility_info/'+id,
        method: 'get',
        success: function (data) {
            //alert(data)
            console.log(data);
            ...
            //alert(object.title_description)
            $('#facility_id').val(object.id);
            $('#facility_name').val(object.facility_name);
            $('#facility_description').val(object.facility_description);
    ...
    swal({
        ...
        function(isConfirm){
            if (isConfirm) {
                //alert('hi')
                swal("Success", "Your imaginary file is deleted", "success");
                window.location.href = '/delete_facility/'+id;
            } else {
                swal("Cancelled", "Your imaginary file is safe :)", "error");
            }
        });
...
function get_academy_data(id) {
    $.ajax({
        url: '/get_academy_info/'+id,
        method: 'get',
        success: function (data) {
            //alert(data)
            console.log(data);
            ...
            //alert(object.title_description)
            $('#academy_id').val(object.id);
            $('#academy_name').val(object.academy_name);
            $('#academy_description').val(object.academy_description);
    ...
    swal({
        ...
        function(isConfirm){
            if (isConfirm) {
                //alert('hi')
                swal("Success", "Your imaginary file is deleted", "success");
                window.location.href = '/delete_academy/'+id;
            } else {
                swal("Cancelled", "Your imaginary file is safe :)", "error");
            }
        });
...
function get_member_data(id) {
    $.ajax({
        ...
        success: function (data) {
            ...
            //alert(object.title_description)
            $('#member_id').val(object.id);
            $('#name').val(object.name);
            $('#designation').val(object.designation);
            $('#mobile').val(object.mobile);
            $('#old_type').val(object.member_type);
            // $('#old_type').val(object.facility_description);
...
function get_news_events_data(id) {
    $.ajax({
        url: '/get_news_events_info/'+id,
        method: 'get',
        success: function (data) {
            //alert(data)
            console.log(data);
            ...
            //alert(object.title_description)
            $('#news_events_id').val(object.id);
            $('#news_events_title').val(object.title);
            $('#date').val(object.date);
            $('#old_logo').attr('src',object.image)
    ...
    swal({
        ...
        function(isConfirm){
            if (isConfirm) {
                //alert('hi')
                swal("Success", "Your imaginary file is deleted", "success");
                window.location.href = '/delete_news_events/'+id;
            } else {
                swal("Cancelled", "Your imaginary file is safe :)", "error");
            }
        });
...
//
//             $.each(JSON.parse(object.gallery_images) ,function (index, value) {
//                 //console.log(value);
//                 $('#old_img').append("<img src='"+value+"' width=\"50\" height=\"auto\"/> &nbsp;");
...
function get_video_data(id) {
    $.ajax({
        ...
        success: function (data) {
            ...
            $('#video_url').val(object.video_url);
            $('#description').val(object.description);
            $('#old_logo').attr('src',object.cover_image)
