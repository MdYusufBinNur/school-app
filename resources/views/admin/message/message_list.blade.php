...
@section('content')
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h4 class="title">Message List</h4>
                    <br>
                                        ...
                                        @foreach($all_messages as $all_message)
                                            <tr>
                                                <td class="text-center">
                                                    <img src="{!! $all_message->image !!}" width="100px" height="auto" alt="">
                                                </td>
                                                <td>{!! $all_message->name !!}</td>
                                                <td>{!! $all_message->designation !!}</td>
                                                <td>{!! $all_message->group !!}</td>

                                                <td>{!! substr($all_message->message,0,50) !!}.....</td>

                                                <td>

                                                    <a href="#" class="btn btn-simple btn-warning btn-icon" data-toggle="modal" id="msg_del" onclick="get_message_data({{$all_message->id}})" data-target="#BrandModal"><i class="ti-pencil-alt"></i></a>

                                                    <a href="" class="btn btn-simple btn-info btn-icon del_brand"  id="del_brand_item" onclick="deleteMessage({{ $all_message->id }})"><i class="ti-trash"></i></a>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Corner Message Information</h4>
                </div>
                <form action="{{ url('/update_message_info') }}" method="post" enctype="multipart/form-data">

                    @csrf()
                    <div class="modal-body">
                        <div class="row" style="padding: 10px">

                            <input type="text" id="message_id" hidden name="message_id">
